...
class Home extends React.Component{
    ...
    uploader() {
        ...
        axios({
            ...
            data:{"Author":in_author, "ImageName": in_imageName, "Tag": in_tag, "FileName": wholePath,"file_name":in_fileName.name}
        }).then((response)=> {
                    ...
                    <MDBCol md="6">
                      <form>
                        ...
                        <div className="text-center mt-4">
                          <MDBBtn color="indigo" onClick={this.uploader}>Upload</MDBBtn>
                        </div>
                      </form>
                    </MDBCol>
                  </MDBRow>
